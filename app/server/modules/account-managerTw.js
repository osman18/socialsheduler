...
var accounts = db.collection('accountsTwitter');
...
{
	accounts.findOne({"userT.email":email}, function(e, o){ if(o){ callback(o); }});
}

exports.getAccountById = function(id, callback)
{
	accounts.findOne({id:id}, function(e, o){ callback(o); });
}
